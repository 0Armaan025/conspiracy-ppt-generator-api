...
def get_slide_content(slide_number, theory):
    ...
    if preset == 'title':
        ...
        image_path = f'image_slide_{slide_number}.png'
...
def generate_ppt():
    ...
    for i, preset in enumerate(slides_preset):
        ...
        if preset == 'title':
            ...
            text_frame = slide.shapes.placeholders[1].text_frame
            slide.shapes.placeholders[1].top = Inches(1.73)  # Move the bullets placeholder up
            slide.shapes.placeholders[1].width = Inches(9)  # Adjust the width of the text box
            ...
            left = Inches(1)
            top = Inches(2)
            pic = slide.shapes.add_picture(img_path, left, top, width=Inches(8), height=Inches(5))
        elif preset == 'thanks':
            slide.shapes.title.text = title
            left = Inches(2)
            top = Inches(3)
